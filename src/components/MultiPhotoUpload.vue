...
.mpu-main{position:absolute;top:6px;left:6px;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;background:var(--accent);color:#fff;padding:3px 7px;border-radius:6px}
...
.mpu-add{aspect-ratio:1;border-radius:12px;border:2px dashed var(--hairline-2);background:var(--surface-2);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;cursor:pointer;color:var(--ink-faint);font-family:inherit;font-size:12px;font-weight:600;transition:all .15s ease}
...
.mpu-err{font-size:12px;color:var(--owed-ink);margin-top:8px}
.mpu-hint{font-size:11.5px;color:var(--ink-faint);margin-top:10px;line-height:1.5}
</style>
