...
<style scoped>
.claim-card{max-width:460px;margin:40px auto;background:var(--surface);border:1px solid var(--hairline);border-radius:18px;padding:32px 28px;text-align:center;box-shadow:var(--shadow-md)}
...
.claim-h{font-size:20px;font-weight:700;margin-bottom:10px}
