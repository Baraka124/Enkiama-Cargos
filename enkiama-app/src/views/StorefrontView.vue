...
.sf-prod-name{font-weight:650;font-size:14px;color:var(--ink);line-height:1.3}
...
.sf-prod-cta{display:inline-flex;align-items:center;gap:3px;font-size:12.5px;font-weight:600;color:var(--buy-ink);background:var(--buy-soft);padding:6px 11px;border-radius:8px;white-space:nowrap}
