...
.biz-stat-v{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:20px;color:var(--ink);letter-spacing:-.02em;line-height:1}
.biz-stat-l{font-size:12.5px;color:var(--ink-faint);margin-top:5px}
...
.biz-quick-card span{font-size:12.5px;color:var(--ink-faint)}
...
.biz-order-switch{margin-left:6px;background:none;border:none;color:var(--accent-ink);font-weight:650;font-size:12.5px;cursor:pointer;font-family:inherit;text-decoration:underline}
...
.carrier-rg{font-size:12.5px;color:var(--ink-faint)}
...
.ins-trend{font-size:11px;font-weight:600;margin-top:8px}
...
.ins-dest-row{display:flex;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid var(--hairline);font-size:13px}
...
.cfb-cash-sub{font-size:11px;color:rgba(255,255,255,.45)}
...
.biz2-eyebrow{display:inline-flex;align-items:center;gap:8px;font-size:12.5px;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:var(--accent-ink);margin-bottom:20px}
...
.biz2-proof-i b{font-family:"Space Grotesk",sans-serif;font-size:16px;font-weight:700;color:var(--ink);letter-spacing:-.02em}
.biz2-proof-i span{font-size:12.5px;color:var(--ink-faint)}
...
.biz2-pv-logo{width:40px;height:40px;border-radius:10px;background:linear-gradient(135deg,var(--accent),var(--accent-ink));color:#fff;display:flex;align-items:center;justify-content:center;font-family:"Space Grotesk",sans-serif;font-weight:700;font-size:18px}
.biz2-pv-name{font-weight:700;font-size:15px;color:var(--ink)}
.biz2-pv-verified{display:inline-flex;align-items:center;gap:3px;font-size:11px;font-weight:600;color:var(--go-ink);background:var(--go-soft);padding:2px 7px;border-radius:999px;margin-top:2px}
...
.biz2-pv-pp{font-family:"Space Grotesk",sans-serif;font-size:12.5px;font-weight:700;color:var(--ink);padding:0 9px 8px}
.biz2-float{position:absolute;display:flex;align-items:center;gap:7px;background:var(--surface);border:1px solid var(--hairline);border-radius:10px;padding:9px 13px;font-size:12.5px;font-weight:650;color:var(--ink);box-shadow:var(--shadow-md);animation:bizFloat 3.5s ease-in-out infinite}
...
.biz2-how-n{font-family:"Space Grotesk",sans-serif;font-size:15px;font-weight:700;color:var(--accent);background:var(--accent-soft);width:34px;height:34px;border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0}
...
.biz-onboard-badge{display:inline-flex;align-items:center;gap:6px;font-size:12.5px;font-weight:650;color:var(--accent-ink);background:var(--accent-soft);padding:6px 14px;border-radius:999px;margin-bottom:20px}
...
.biz-step-num{width:30px;height:30px;border-radius:10px;background:var(--accent);color:#fff;display:flex;align-items:center;justify-content:center;font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:14px;margin-bottom:14px;box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 2px 6px rgba(11,110,93,.3)}
