...
export function usePlatform() {
  ...
  const pendingProperties = () => supabase.rpc('admin_pending_properties')
  const reviewProperty = (id, decision, fair) => supabase.rpc('admin_review_property', { p_id: id, p_decision: decision, p_fair_price: fair })
  ...
  return {
    ...
    pendingProperties, reviewProperty,
  }
}
